        ...
        <>
            <div className='wrapper-articles'>
                ...
                <div className='div-cards'>
                    <Articles foto={article1} title={'Como preparar sua empresa para uma auditoria financeira'} category={"Gestão Empresarial"} contentId="1"/>
                    <Articles foto={article2} title={'Descubra como a tecnologia está transformando o crédito'} category={"Crédito Empresarial"} contentId="4" />
                    <Articles foto={article3} title={'Superando as barreiras do crédito'} category={"Crédito Empresarial"} contentId="3"/>
                </div>
