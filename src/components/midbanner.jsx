                ...
                <div className='midbanner-background'>
                    <div className='wrapper-midbanner'>
                        <div className='first-block'>
                            <div className='title'>
                                <h1>Na hora de planejar o futuro da sua empresa, conte com a <p style={{ color: '#20509F' }}> Versa Finance</p></h1>
                            </div>
                            <div className='text-midbanner'>
                                <p>Descubra a diferença da Versa Finance e experimente a verdadeira personalização em serviços financeiros. Vamos juntos desenhar o seu futuro financeiro.</p>
                            </div>
                        </div>
